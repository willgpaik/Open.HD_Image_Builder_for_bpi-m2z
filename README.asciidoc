...
> **NOTE: This version allows Open.HD to be installed on  Banana Pi M2 Zero**
>
> - Only minor changes are made from original repo unless "bpi-stretch" is selected
- Not guaranteed to work
- Need 60 GB for "bpi-stretch"
